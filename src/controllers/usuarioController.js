                ...
                function (resultadoAutenticar) {
                    ...
                    if (resultadoAutenticar.length == 1) {
                        ...
                        res.json({
                            ...
                            bluesky: resultadoAutenticar[0].bluesky,
                            youtube: resultadoAutenticar[0].youtube,
                            discord: resultadoAutenticar[0].discord,
                            outros1: resultadoAutenticar[0].outros1,
                            outros2: resultadoAutenticar[0].outros2,
                        });
